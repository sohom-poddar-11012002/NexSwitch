...
@AnalyzeClasses(packages = "com.nexswitch.domain")
class PortsArchitectureTest {

    @ArchTest
    static final ArchRule inboundUseCasesMustBeInterfaces =
        classes()
            .that().resideInAPackage("com.nexswitch.domain.port.inbound..")
    ...
    static final ArchRule outboundPortsMustBeInterfaces =
        classes()
            .that().resideInAPackage("com.nexswitch.domain.port.outbound..")
    ...
    static final ArchRule portsMustNotDependOnAdapters =
        noClasses()
            .that().resideInAPackage("com.nexswitch.domain.port..")
