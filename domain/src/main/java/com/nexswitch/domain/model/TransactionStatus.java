...
public enum TransactionStatus {
    ...
    static {
        ...
        VALID_TRANSITIONS.put(AUTHORIZED,            Set.of(CAPTURED, REVERSAL_PENDING, REFUND_INITIATED));
        ...
        VALID_TRANSITIONS.put(RECONCILED,            Set.of(PAID_OUT, CHARGEBACK_RECEIVED));
        VALID_TRANSITIONS.put(PAID_OUT,              Set.of(CHARGEBACK_RECEIVED, REFUND_INITIATED));
