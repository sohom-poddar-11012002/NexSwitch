...
ALTER TABLE merchant_reserve_accounts
...
-- LEARN: CREATE INDEX CONCURRENTLY builds without a write lock; fine for prod live traffic.
--        Omitted here — CONCURRENTLY cannot run inside a Flyway migration transaction.
